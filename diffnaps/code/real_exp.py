...
conf_dict["facebook"] = TrainConfig(hidden_dim = 2000, epochs=100, weight_decay=10.0, elb_k=10, elb_lamb=10, class_elb_k=20, class_elb_lamb=20,
                               lambda_c = 25.0, regu_rate=1.1, class_regu_rate=1.1, batch_size=32,
                         log_interval=100, sparse_regu=0, test=False, lr=0.001, model=DiffnapsNet,seed=14401360119984179300,init_enc="bimodal")
conf_dict["facebook"].t1=0.03
conf_dict["facebook"].t2=0.8

conf_dict["synthetic"] = TrainConfig(hidden_dim = 2000, epochs=25, weight_decay=5.0, elb_k=10, elb_lamb=10, class_elb_k=20, class_elb_lamb=20,
                               lambda_c = 25.0, regu_rate=1.1, class_regu_rate=1.1, batch_size=32,
                         log_interval=100, sparse_regu=0, test=False, lr=0.005, model=DiffnapsNet,seed=14401360119984179300,init_enc="bimodal")
conf_dict["synthetic"].t1=0.03
conf_dict["synthetic"].t2=0.8

conf_dict["polluted_synthetic"] = TrainConfig(hidden_dim = 500, epochs=50, weight_decay=5.0, elb_k=10, elb_lamb=10, class_elb_k=20, class_elb_lamb=20,
                               lambda_c = 25.0, regu_rate=1.1, class_regu_rate=1.1, batch_size=128,
                         log_interval=100, sparse_regu=0, test=False, lr=0.01, model=DiffnapsNet,seed=14401360119984179300,init_enc="bimodal")
conf_dict["polluted_synthetic"].t1=0.03
conf_dict["polluted_synthetic"].t2=0.8

conf_dict["brca-n"] = TrainConfig(hidden_dim = 10000 , epochs=100, weight_decay=10.0, elb_k=10, elb_lamb=10, class_elb_k=20, class_elb_lamb=20,
                               lambda_c = 25.0, regu_rate=1.1, class_regu_rate=1.1, batch_size=64,
                         log_interval=100, sparse_regu=0, test=False, lr=0.005, model=DiffnapsNet,seed=14401360119984179300,init_enc="bimodal")
conf_dict["brca-n"].t1=0.03
conf_dict["brca-n"].t2=0.8
...
if args.dataset == "cardio":
    ...
    data, labels, translator = load_facebook()
    label_dict = {0:"non-government",1:"government"}
elif args.dataset == "synthetic":
    data, labels, translator = load_synthetic()
    label_dict = {0:"0",1:"1"}
elif args.dataset == "polluted_synthetic":
    data, labels, translator = load_synthetic_polluted()
    label_dict = {0:"0",1:"1"}
